...
func ValidateTaskAndStudentIds(taskId, studentId string, log *slog.Logger) error {
	const op = "Handler.Validation.ValidateTaskAndStudentIds"
	...
	err = ValidateIdWrapped(studentId, "student", logger)
	if err != nil {
		return err
	}
